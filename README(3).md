...
No. of Weeks	6 Weeks
Project Name	Credit Risk Prediction Using XGBoost
Project Scope	Developed an end-to-end machine learning solution for credit risk prediction using the XGBoost algorithm. The project included data preprocessing, exploratory data analysis (EDA), feature engineering, handling missing values and categorical features, model training, hyperparameter tuning using RandomizedSearchCV, performance evaluation using Accuracy, Precision, Recall, F1-Score, ROC-AUC, and Confusion Matrix, comparison with other classification algorithms, and model serialization using Joblib for future deployment.
